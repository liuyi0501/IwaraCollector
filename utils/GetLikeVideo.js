...
function GetPage(LastPage, d) {
    ...
    ecchi.get('/videos?sort=likes&page=' + d).then(response =>{
        ...
        //console.log(pages.indexOf('page='))
            ...
            fs.writeFileSync('./data/www/like/'+d+'.json','{"video":["'+Vid.join('","')+'"],"thumb":["'+  thumb.join('","')+'"],"title":["'+ title.join('","') +'"]}', function (err) {
...
function GetAllVideo() {
    ...
    axios.get('https://www.iwara.tv/videos?sort=likes&page=0', {//获取页面信息
        header:{
            referer: 'https://www.iwara.tv/',
        ...
        fs.writeFileSync('./data/www/like/all.json','{"LastPage":"'+PageLast+'"}',function(err){
            if(err)throw(err)
        })
        let video = []
        let thumb = []
        ...
        fs.writeFileSync('./data/www/like/'+0+'.json','{"video":["'+Vid.join('","')+'"],"thumb":["'+ thumb.join('","') +'"],"title":["'+ title.join('","') +'"]}', function (err) {
